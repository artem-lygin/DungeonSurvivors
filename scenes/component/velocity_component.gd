...
func accelerate_to_player() -> void:
	...
	var direction_raw: Vector2 = (player.global_position - owner_node2d.global_position).normalized()
	var direction: Vector2 = IsoUtils.to_isometric_length(direction_raw)
