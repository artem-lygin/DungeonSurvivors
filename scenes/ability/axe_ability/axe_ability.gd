...
func _spawn_axe_ghost() -> void:
	var axe_ghost_instance = axe_ghost_scene.instantiate()
	get_parent().add_child(axe_ghost_instance)
	axe_ghost_instance.global_position = global_position
	axe_ghost_instance.global_rotation = global_rotation
